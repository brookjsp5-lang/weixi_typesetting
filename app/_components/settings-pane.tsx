  ...
  return (
    <div className="space-y-1">
      <div className="flex justify-between text-xs font-black text-(--neo-ink)">
        <span>{label}</span>
        <span
          className={`${badgeClassNames[tone]} border border-(--neo-line) rounded-md px-1.5 text-(--neo-ink)`}
        >
          {displayValue}
        </span>
      </div>
...
export function SettingsPane({
  ...
  return (
    <div
      className={`${
        embedded ? "w-full" : "w-full md:w-64 lg:w-[320px] shrink-0 pb-24 md:pb-0"
      } flex-col gap-4 h-full overflow-hidden ${embedded || activeTab === "workflow" ? "flex" : "hidden md:flex"}`}
    >
      <div
      ...
      >
        ...
        {isTemplatesOpen && (
          <>
            <div className="relative shrink-0 bg-(--neo-sub-header) border-b border-(--neo-line)">
              <div
              ...
              <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center bg-linear-to-l from-(--neo-sub-header) via-(--neo-sub-header) to-transparent pl-6 pr-2">
                <button
                  ...
                  className="pointer-events-auto flex items-center justify-center border border-(--neo-line) rounded-lg bg-(--neo-surface) p-1 text-(--neo-ink) shadow-sm active:translate-y-px active:shadow-none"
            ...
            <div className="p-3 overflow-y-auto flex-1 content-start bg-(--neo-surface) custom-scrollbar space-y-3">
              ...
              {/* 调色板工具 */}
              <div className="border border-(--neo-line) rounded-xl bg-(--neo-surface) p-2.5 shadow-sm">
                ...
                <div className="flex gap-2">
                  <div className="relative w-10 h-10 shrink-0 border border-(--neo-line) rounded-xl shadow-sm overflow-hidden cursor-pointer active:translate-y-px active:shadow-none">
                    <input
                      type="color"
                  ...
                  <input
                    ...
                    onChange={(e) => updateFormatTweaks("themeColor", e.target.value)}
                    className="flex-1 h-10 px-3 py-2 border border-(--neo-line) rounded-xl bg-(--neo-surface) text-xs font-bold text-(--neo-ink) focus:outline-none focus:border-(--neo-green) placeholder:text-gray-400"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-12 items-center rounded-full border border-(--neo-line) transition-colors duration-200 focus:outline-none ${
                ...
                <div className="flex gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`flex-1 px-3 py-2 text-xs font-black border border-(--neo-line) rounded-lg transition-all duration-200 ${
                        formatTweaks.h1Layout === option.value
                          ? "bg-(--neo-pink) border-(--neo-green) text-[#065f46]"
              ...
              <div className="border border-(--neo-line) rounded-xl bg-(--neo-surface) p-3 space-y-3">
      ...
      <div className={`${embedded ? "block" : "hidden md:block"} neo-panel p-4 shrink-0`}>
        <div className="flex items-center justify-between">
