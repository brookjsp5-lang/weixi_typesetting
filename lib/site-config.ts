...
export const SITE_TITLE_DEFAULT = `${SITE_BRAND}｜${SITE_PRODUCT_NAME} — 专业的 Markdown 转微信排版工具 · 96 套精美模板 · 智能排版优化`;

/**
 * <meta name="description">：首句包含品牌与域名，便于品牌词与「site:typezen.online」类检索
 */
export const SITE_DESCRIPTION = `${SITE_BRAND}（${SITE_HOST}）是免费在线 Markdown 转微信公众号排版工具，支持 AI 一键优化排版结构，提供新粗野、极简、商务、文艺、科技、节庆、好味手帐、宠物贴贴社 8 大类共 96 套精美模板，并支持实时预览、样式微调与一键复制发布。`;
